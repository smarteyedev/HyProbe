...
{
    /// <summary>
    /// Represents a key on the keyboard that has a string moodValue for input.
    /// </summary>
    [RequireComponent(typeof(Button))]
    public class KeyboardValueKey : MonoBehaviour
    {
        /// <summary>
        /// The default string moodValue for this key.
        /// </summary>
        //[Experimental]
        public string Value;

        /// <summary>
        /// The shifted string moodValue for this key.
        /// </summary>
        ...
        {
            // Shift moodValue should only be applied if a shift moodValue is present.
