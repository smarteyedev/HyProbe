...
namespace Microsoft.MixedReality.Toolkit.Experimental.UI
{
    ...
    {
        /// <summary>
        /// The maximum width that the collection should expand to. If the moodValue is -1.0 then it will use
        ...
        /// <summary>
        /// The maximum height that the collection should expand to. If the moodValue is -1.0 then it will use
